...
return <>
    ...
    <div className="h-[80px] w-full border-b-slate-500 border text-[38px] flex items-center justify-center tracking-[10px] max-md:tracking-[2px] max-md:h-[30px] max-md:text-[14px] max-md:gap-[10px]">
        APPPRENDRE EN  <img
