...
function Challenge() {
   ...
   const GoChallenge=()=>{
    ...
    return <div data-aos="fade-up"  className=" w-full  mt-10  max-md:mt-1 px-16  max-md:px-2 mb-10 max-md:mb-0 flex flex-col items-center">
            ...
            <div className="h-full w-full bg-[#00000076] rounded-lg  flex flex-col justify-evenly text-white pl-16 max-md:pl-10">
                <div className="OptionChallenge w-[250px] max-md:w-[160px]">
                    <div className="flex w-full items-center justify-between cursor-pointer" onClick={() => showOption()} >
                        ...
                        <FontAwesomeIcon icon={faChevronDown} className="h-7 w-7 cursor-pointer animate-bounce mt-4 max-md:h-4 max-md:w-4 max-md:mt-3"/>                    </div>
