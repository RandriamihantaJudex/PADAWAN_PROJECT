...
const PresentationVideo = () => {
    ...
    return (
        <div className="videoContainer w-full my-16 max-md:my-1 h-96 max-md:h-60 border-2 border-[red] centrer flex items-center justify-center anime-on-show">
                ...
                <div className="redAbsolute h-60 flex items-center justify-center   ">
                        ...
                        <div className="h-full w-full text-white p-4 flex-col justify-between hidden max-lg:flex max-sm:justify-center">
                            ...
                            >
                                ...
                                <img
                                    ...
                                    className="h-5 w-5 cursor-pointer ml-2 mt-1"
                                    alt="menu"
                                ></img>
                            </button>
                        </div>
                    ...
                    <div className="h-full  w-5/12 text-white  flex flex-col justify-between max-lg:hidden">
                        ...
                        >
                            ...
                            <img
                                src="./images/video.png"
                                className="h-5 w-5 cursor-pointer ml-2 mt-1 max-md:h-1 max-md:w-1"
                                alt="menu"
                            ></img>
                        </button>
                    </div>
