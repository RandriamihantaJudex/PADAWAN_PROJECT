...
const CarteTemoignage = ({nom,prenom,domaine,temoignage,star}) => {
    ...
    return <div className="h-full w-[370px] max-md:w-full max-md:h-[300px] bg-[#008F64] rounded-md flex flex-col justify-between text-white">
        ...
        <div className="flex justify-between px-6 h-1/6 py-9 items-center max-md:py-1">
            <FontAwesomeIcon icon={faHeart} className="h-6 w-6 max-md:h-6 max-md:w-6" />
            <div className="flex">
            ...
            <FontAwesomeIcon icon={faPaperPlane} className="h-6 w-8 max-md:h-6 max-md:w-6" />
        </div>
    </div>
}
...
function Temoignage() {
    return <div data-aos="fade-up"  className=" w-full flex flex-col items-center mt-24 mb-16 max-md:mt-8 max-md:mb-0">
